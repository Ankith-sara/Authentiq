...
import { Brain, Shield, Users, Zap, ArrowRight } from "lucide-react";
...
const About = () => (
  <div style={{ minHeight: "100vh", background: "#000000" }}>
    ...
    <section style={{ padding: "130px 12px 80px", maxWidth: 840, margin: "0 auto" }}>
      <p style={{ fontSize: 12, fontWeight: 600, color: "#2563eb", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 20 }}>About</p>
    ...
    <div style={{ borderTop: "1px solid #2563eb", maxWidth: 1100, margin: "0 auto" }} />
    <section style={{ padding: "80px 24px", maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "280px 1fr", gap: 64, alignItems: "start" }} className="block sm:grid">
      <div>
        <p style={{ fontSize: 12, fontWeight: 600, color: "#2563eb", textTransform: "uppercase", letterSpacing: "0.1em" }}>Mission</p>
      </div>
      <div>
    ...
    <section style={{ padding: "80px 24px", maxWidth: 1100, margin: "0 auto" }}>
      <p style={{ fontSize: 12, fontWeight: 600, color: "#2563eb", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 40 }}>What we stand for</p>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 1, border: "1px solid #2563eb", borderRadius: 12, overflow: "hidden" }}>
        {[
          ...
          <div key={title} style={{ padding: "32px", background: i % 2 === 0 ? "rgba(255,255,255,0.015)" : "transparent", borderRight: "1px solid #2563eb", borderBottom: "1px solid #2563eb" }}>
    ...
    <section style={{ padding: "80px 24px", maxWidth: 720, margin: "0 auto" }}>
      ...
      <p style={{ fontSize: 14, color: "#2563eb" }}>— The Authentiq team</p>
    </section>
    ...
    <section style={{ padding: "80px 24px", maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 24 }}>
      ...
      <Link to="/beta" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "11px 22px", borderRadius: 8, fontSize: 14, fontWeight: 600, background: "#ffffff", color: "#000000", textDecoration: "none" }}>
